...
namespace Proyecto_BD.Migrations
{
    ...
    [Migration("20250629032150_bitacora")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Proyecto_BD.Models.Bitacora", b =>
                {
            ...
            modelBuilder.Entity("Proyecto_BD.Models.Cita", b =>
                {
                    ...
                    b.Property<int>("ID_Cita_Horario")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Proyecto_BD.Models.CitasHorario", b =>
                {
                    ...
                    b.Property<TimeOnly>("Hora_Cita")
                        .HasColumnType("time");

                    b.Property<bool>("JornadaHorario")
                        .HasColumnType("bit");

                    b.HasKey("ID_Horario");

                    b.ToTable("CitasHorario");
                });
            ...
            modelBuilder.Entity("Proyecto_BD.Models.Cita", b =>
                {
                    b.HasOne("Proyecto_BD.Models.CitasHorario", "CitasHorario")
                        .WithMany("Cita")
                        .HasForeignKey("ID_Cita_Horario")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();
