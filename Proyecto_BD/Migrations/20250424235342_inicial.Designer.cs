...
namespace Proyecto_BD.Migrations
{
    ...
    [Migration("20250424235342_inicial")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Proyecto_BD.Models.Ticket", b =>
                {
                    b.HasOne("Proyecto_BD.Models.Medicina", "Medicina")
                        .WithMany()
                        .HasForeignKey("ID_Medicina")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("Proyecto_BD.Controllers.Servicio", "Servicio")
                        .WithMany()
